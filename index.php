...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./">EVENT ORGANIZER<br><i style="font-size:14px;">online</i></a>
            </div>
            ...
            <div class="header-right">
                ...
                <button onclick="window.location='./login/logout.php';" class="btn btn-danger" title="log out"><i class="fa fa-sign-out fa-2x"></i></button>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#" title="Tentang Seluruh Pengguna"><i class="fa fa fa-users "></i>Penyedia jasa<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a href="./?p=daftar_pengguna" title="Pengguna Terdaftar"><i class="fa fa-list"></i>Daftar Penyedia jasa</a>
                            </li>
                           
                        </ul>
                           <li>
                        <a href="#" title="Daftar Pengguna Online"><i class="fa fa fa-circle "></i>daftar pengguna sedang online<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <?php
                     ...
                     <li>
                         <a href="./?p=galeri" title="Semua Foto Di Postingan"><i class="fa fa-photo"></i>tawaran</a>
                     </li>
                </ul>
    ...
    <div id="footer-sec">
        &copy; dunia per-event-an online <span style="float:right;">Design By : <b>Indria Agustina</b>
    </div>
    <!-- /. FOOTER  -->
...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li>
                        <div style="height:25px;background:#800000">
                        </div>
                    ...
                    <li>
                        <a href="#"><i class="fa fa fa-users "></i>Pengguna event organizer online <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                            <li>
                                <a href="./login/"><i class="fa fa-reply"></i>Login</a>
                            </li>
                            <li>
                                <a href="./?p=daftar_pengguna"><i class="fa fa-list "></i>Daftar penyedia jasa</a>
                            </li>
                        </ul>
                    </li>
                           <li>
                        <a href="./?p=galeri"><i class="fa fa-photo"></i>tawaran</a>
                    </li>
                </ul>
    ...
    <div id="footer-sec">
        &copy; dunia event organizer<span style="float:right;">Design By : <b>Indria Agustina</b>
    </div>
    <!-- /. FOOTER  -->
    <!-- SCRIPTS -AT THE BOTOM TO REDUCE THE LOAD TIME-->
    <!-- JQUERY SCRIPTS -->

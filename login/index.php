...
<link rel="icon" href="../fav.jpg" type="image/jpg" size="50px">
    ...
    <title>Login User - event organizer online</title>
    ...
    <div class="container">
        <div class="row text-center " style="padding-top:100px;">
            ...
            <style>
                ...
                <a href="../" class="login"><font style="font-family:Kristen ITC;font-size:25px;">event organizer</font><br>
                Halaman Login</a>
            </div>
        </div>
         <div class="row ">
                                ...
                                ?>
                                    ...
                                    <div class="form-group">
                                            <span class="pull-right">
                                                   <a href="#" onclick="alert('aku pun tak tahu!')" >Lupa Password ? </a> 
                                            </span>
                                        </div>

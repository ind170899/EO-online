...
if (@$_SESSION["user"]) {
?>
<title><?php echo $data2["nama_user"];?> | tawaran - EO online</title>
<?php
}
else{
?>
<title>tawaran - EO ONLINE</title>
<?php
}
?>
<style>
...
<div id="page-inner">
 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">contoh tema yang ada pada event organizer online</h1>

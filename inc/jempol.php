...
?>
<title><?php echo $datauseruser["nama_user"];?> | Notifikasi Jempol - event organizer Users</title>
<?php
if (@$_SESSION["user"] == $useruser) {
    ...
    <div id="page-inner">
        <div class="row">
            ...
            <h3 class="page-subhead-line">Jika Pengguna Lain Memberi Jempol Pada Postingan <b><?php echo $data2["nama_user"];?></b>, Maka Akan Tampil Disini</h3>

    ...
    <div class="c-err">
        ...
        <div class="row ">
            ...
            <h3>Halaman Tidak Ditemukan</h3>
                        <p style="font-family:Comic Sans MS"><i class="fa fa-heart fa-spin"></i>  silahkan periksa kembali <i class="fa fa-heart fa-spin"></i></p>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-md-12">
                ...
                All Rights Reserved | &copy 2020 dunia event organizer(q)
            </div>

...
?>
<title><?php echo $datauseruser["nama_user"];?> | Tambah Postingan - jasa</title>
<?php
...
<div id="page-inner">
 <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line"><li class="fa fa-pencil fa-spin"></li> Menambah Postingan jasa event organizer</h1>

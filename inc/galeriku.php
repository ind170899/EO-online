...
if (@$_SESSION["user"]) {
?>
<title><?php echo $data2["nama_user"];?> | tawaran jasa - EO online</title>
<?php
}
else{
?>
<title>tawaran yang tersedia</title>
<?php
}
$by = @$_GET["by"];
...
<div id="page-inner">
 <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line"><li class="fa fa-photo"></li> Semua Foto Dari Postingan <b><?php echo $databy["nama_user"];?></b></h1>                  
            </div>
            </div>
<?php
$batas = 8;
...
$tampil_gambar = mysqli_num_rows($querygambar);
if ($tampil_gambar > 0) {
...
?>
<div class="alert alert-info">Belum Ada tawaran Yang Dapat Di Tampilkan</div>
<?php
}
?>
